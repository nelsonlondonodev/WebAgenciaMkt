const translations = {
  es: {
    ...
    pageDescription:
      'Transformo tu negocio con un diseño web a medida en Fuente el Saz del Jarama. Páginas rápidas, optimizadas para SEO y enfocadas en resultados.',
    badgeNew: 'Nuevo',
    ...
    aboutProDesc:
      'Compromiso total con la calidad, la comunicación transparente y la entrega puntual de cada proyecto.',
    aboutModernTitle: 'Modernidad',
    aboutModernDesc:
      'Uso de las últimas tecnologías y tendencias para crear soluciones digitales frescas e impactantes.',
    aboutAdaptTitle: 'Adaptación',
    aboutAdaptDesc:
      'Soluciones flexibles y a medida que evolucionan junto a las necesidades de tu negocio.',
  ...
  en: {
    ...
    pageDescription:
      'I transform your business with custom web design in Fuente el Saz del Jarama. Fast, SEO-optimized, and results-focused pages.',
    badgeNew: 'New',
    ...
    whatsappButton: '<i class="fab fa-whatsapp mr-2"></i> Contact via WhatsApp',
    articleContent: `
            <p>
    ...
    aboutProDesc:
      'Total commitment to quality, transparent communication, and timely delivery of each project.',
    aboutModernTitle: 'Modernity',
    aboutModernDesc:
      'Use of the latest technologies and trends to create fresh and impactful digital solutions.',
    aboutAdaptTitle: 'Adaptation',
    aboutAdaptDesc:
      'Flexible and tailor-made solutions that evolve with the needs of your business.',
...
function setLanguage(lang) {
  ...
  if (!langIndicator) {
    console.error('CRITICAL: El elemento #langIndicator no existe en el HTML.');
    return;
  }
  ...
  if (window.location.pathname.includes('articulo-seo-post-fiestas.html')) {
    ...
    translationsUrl =
      './translations/articulo-redes-sociales-publicidad-local.json';
