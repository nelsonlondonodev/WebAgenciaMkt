(() => {
  ...
  var CONFIG = {
    ...
    PRICING: {
      ...
      SEO_LOCAL_EXPRESS: {
        ...
        CURRENCY: "\u20AC",
        SUFFIX: "",
        NOTE: "Pago \xFAnico. Impuso inicial para tu negocio."
      },
      SEO_GENERAL: {
        MIN_PRICE: 275,
        CURRENCY: "\u20AC",
  ...
  // src/js/sectionStyler.js
  function applyAlternatingGradients(containerSelector, gradientClasses) {
  ...
  var loadStaticComponent = async (selector, url) => {
    try {
  ...
  var loadConfigurableComponent = async (element) => {
  ...
  var portfolioData = [
    {
      ...
      imgAlt: "Web de Narbo's Sal\xF3n Spa",
      title: "Narbo's Sal\xF3n Spa - Web de Alto Rendimiento",
      tags: "C\xF3digo Propio / SEO T\xE9cnico / Performance",
      description: "Desarrollo a medida con HTML, CSS y JS puro. Optimizada para una carga ultra r\xE1pida y un posicionamiento org\xE1nico que domina el sector de belleza.",
      type: "link",
    ...
    },
    {
      ...
      description: "Escalamos la visibilidad de una barber\xEDa premium de la posici\xF3n 9 al Top 3 de Google Maps en toda su \xE1rea. Citas y llamadas reales multiplicadas.",
      type: "link",
    ...
    },
    {
      ...
      imgAlt: "CRM de Fidelizaci\xF3n con n8n e IA",
      title: "CRM Inteligente - Sistema de Fidelizaci\xF3n",
      tags: "IA / Automatizaci\xF3n n8n / CRM Propio",
      description: "Plataforma CRM con flujos de n8n que automatizan el env\xEDo de bonos QR, gesti\xF3n de bases de datos y felicitaciones de cumplea\xF1os 24/7.",
      type: "link",
    ...
    },
    {
      ...
      title: "Blond Bros Barber - \xC9xito Local 2026",
      tags: "Google Maps / Estrategia Local / Fuente el Saz",
      description: "Transformamos un perfil abandonado en el l\xEDder de su pueblo. Gesti\xF3n integral de rese\xF1as, fotos de remodelaci\xF3n y optimizaci\xF3n GMB.",
      type: "link",
      url: "https://g.co/kgs/UfU8p6E"
      // URL basada en el GMB ID visible en el mapa si lo tuviera, pero uso un placeholder coherente o link de google maps
    }
  ];
  ...
  var testimonialsData = [
    ...
    {
      reviewUrl: "https://maps.app.goo.gl/example",
      text: "Que excelente servicio, muy c\xE1lido, humano, paciente con much\xEDsimo conocimiento... me ayud\xF3 con la optimizaci\xF3n de mi ficha, estoy m\xE1s que agradecida. En solo 3 d\xEDas tuve m\xE1s visitas que en 4 a\xF1os de tener la ficha sin su gran aporte.",
      author: "Yaneira Hernandez",
      service: "Optimizaci\xF3n ficha Google",
      stars: 5
    },
    {
      reviewUrl: "https://maps.app.goo.gl/example",
      ...
      author: "Locu Elpilon",
      service: "Consultor\xEDa Digital",
      stars: 5
    },
    {
    ...
    {
      reviewUrl: "https://www.google.com/search?q=Nelson+Londo%C3%B1o+Agencia&stick=H4sIAAAAAAAA_-NgU1I1qLBINjczNk-2sDA1NEg1SzS2MqgwMjI0SjU3SUo1N01NTDIxXsQq7peaU5yfp-CTn5eSf3hjvoJjempecmYiABacRYxDAAAA&hl=es-419&mat=CYq8wdlAKeDAElYBYJahaebtY79hgszIXmN9x-LjjUAkK5Yano7rVbE2hNRNQQZJJXy3Y6uJnd75CPNnNplduE4XCTP3gujhcfEojKLWSWUMb1WK4bHjA7M0au9UIlHRAw&authuser=0#mpd=~13898153808573349002/customers/reviews?p%3DCg51cGRhdGV0aW1lZGVzYxIDYWxs",
      text: "Nelson es un desarrollador web altamente capacitado y comprometido. Su capacidad para resolver problemas t\xE9cnicos de manera eficiente y su proactividad para proponer soluciones innovadoras fueron muy valiosas.",
      author: "Aleja Villa",
  ...
  // src/js/testimonialCarousel.js
  var CAROUSEL_ANIMATION_DURATION = "150s";
  var MIN_CARDS_FOR_LOOP = 12;
  ...
  function generateBreadcrumbs(placeholderSelector) {
    const placeholder = document.querySelector(placeholderSelector);
    if (!placeholder) {
      return;
    }
    const path = window.location.pathname;
    const pageFileName = path.substring(path.lastIndexOf("/") + 1) || "index.html";
    ...
    if (pageFileName.startsWith("articulo-")) {
      ...
      const customTitle = placeholder.getAttribute("data-breadcrumb") || placeholder.closest("[data-breadcrumb]")?.getAttribute("data-breadcrumb");
      const articleTitle = customTitle || document.querySelector("h1")?.textContent.trim();
      if (articleTitle) {
        crumbs.push({ name: articleTitle });
      }
  ...
  function attachContactFormListeners(contactForm) {
    ...
    const statusMessage = contactForm.querySelector("#form-status") || contactForm.nextElementSibling;
    ...
    contactForm.addEventListener("submit", async function(e) {
      ...
      try {
        ...
        if (response.ok) {
          updateStatus("\xA1Mensaje enviado con \xE9xito!", "success");
          contactForm.reset();
        } else {
          updateStatus("Hubo un error al enviar el mensaje. Int\xE9ntalo de nuevo.", "error");
        }
      } catch (error) {
        updateStatus("Hubo un problema de conexi\xF3n. Revisa tu internet.", "error");
      } finally {
        if (submitButton) {
          setTimeout(() => {
  ...
  `;
    ...
    copyBtn.addEventListener("click", () => {
      navigator.clipboard.writeText(value).then(() => {
        ...
        copyBtn.innerHTML = '<i class="fas fa-check"></i> \xA1Copiado!';
  ...
  function initSuccessCaseCarousels() {
  ...
  function initHeroBenefitBadge() {
    ...
    if (heroMain && heroMain.dataset.showBadge === "true" && !document.querySelector(".hero-benefit-badge")) {
      ...
      badge.textContent = "\u{1F680} Objetivo: Llevamos tu negocio al Top 3 de Google Maps.";
      setTimeout(() => {
        const subtitle = document.querySelector(".max-w-4xl p");
        if (subtitle) {
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    ...
    initDarkMode();
    initSmoothScroll();
    applyAlternatingGradients("main", ["section-gradient-green", "section-gradient-blue"]);
