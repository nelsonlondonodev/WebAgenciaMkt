(() => {
  ...
  async function openContactModal(prefillMessage = "") {
    let componentHtml = "";
    try {
    ...
    if (formElement) {
      formElement.classList.replace("gap-y-6", "gap-y-4");
  ...
  function setupContactModal(triggerSelector, prefillMessage) {
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    ...
    setupContactModal(
      ...
      "Hola Nelson, me interesa solicitar la prueba gratuita de 60 d\xEDas de SEO Local. \xBFPodemos hablar?"
    );
    initCookieConsent();
    setupSocialSharing();
  });
